...
{{-- Shineer nemsen comment --}}
{{-- github comment --}}
@section('content')
    <div class="movie-info border-b border-gray-800">
      <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row ">
        <div class="flex-none">
          <img src="/img/parasite.jpg" alt="parasite" class="w-96 sm:min-w-full md:min-w-0">
        </div>
        <div class="md:ml-24">
          <h2 class="text-4xl font-semibold mt-8 md:mt-0">Parasite (2019)</h2>
          <div class="flex items-center text-gray-400 text-sm flex-wrap">
            ...
            <p class="text-gray-300 mt-8">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quisquam fugiat iusto assumenda, veniam itaque laborum ipsa. Ratione distinctio reiciendis atque. Sed praesentium doloremque deleniti, accusamus architecto excepturi quia molestiae fugiat ea hic id repudiandae, saepe nemo in minus dolorum qui soluta a! Eligendi corporis vero aut excepturi dolorum dolores at.
            </p>
            ...
            <div class="mt-12">
              <button class="flex items-center bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transision ease-in-out duration-150">
    ...
    <div class="movie-cast border-b border-gray-800">
      <div class="container mx-auto px-4 py-16">
        ...
        <div class="now-playing-movies py-8"> <!-- Start of actors -->
